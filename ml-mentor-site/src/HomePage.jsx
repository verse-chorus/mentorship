  ...
  const services = [
    {
      ...
      description:
        "Пошаговое обучение: от теории к практике. Ключевые концепции + задачи."
    },
    {
      title: "Адаптация на новой роли",
      description:
    ...
    },
    {
      ...
      description:
        "Разбор ML, coding, system design + обратная связь."
    },
    {
      title: "Резюме",
      description:
        "Как выделиться среди сотен кандидатов и подать себя выгодно."
    },
    {
    ...
    },
    {
      ...
      description:
        "Пишем код как профи. CI/CD, тесты, деплой моделей."
    },
    {
    ...
    <main className=\"max-w-5xl mx-auto p-6 space-y-10\">
      ...
      <section className=\"text-center pt-10\">
        <p className=\"text-muted-foreground text-sm\">
          Telegram: <a href=\"https://t.me/yourtelegram\" className=\"underline\">@yourtelegram</a>
        </p>
        <p className=\"text-muted-foreground text-sm\">
          Методичка и RoadMap доступны по запросу
        </p>
      </section>
    </main>
  );
